...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Sanarya.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BS", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Sanarya -X kill
screen -S Sanarya ./Sanarya
done
]])  
file:close() 
...
local GLOBLA = false  
if tonumber(msg.sender_user_id_) == tonumber(777510580) then
GLOBLA = true  
end
return GLOBLA  
end 
...
local Sanarya_Msg = ''  
if msgs < 100 then 
Sanarya_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Sanarya_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Sanarya_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Sanarya_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Sanarya_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Sanarya_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Sanarya_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Sanarya_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Sanarya_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
Sanarya_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Sanarya_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Sanarya_Msg = 'امبروطور التفاعل☣️' 
elseif msgs < 10000000000 then 
Sanarya_Msg = 'رب التفاعل💖'  
end 
return Sanarya_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSanarya(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,Sanarya_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf Sanarya.lua')
os.execute('wget https://raw.githubusercontent.com/hsiioe/Sanarya/master/Sanarya.lua')
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..Sanaryak..''..Sanarya..'\n*📌┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤¦ العضو » ['..result.title_..'](t.me/'..(username or 'DEVSanarya')..')'
...
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVSanarya')..')'
status  = '\n📫¦ تم ترقيته مطور في البوت'
...
local Sanarya_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Sanarya_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..Sanarya_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/DEVSanarya)}\n📛¦["..Sanarya_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/DEVSanarya)}\n📛┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
┄─━━◉━━─┄┄─━━◉━━─┄
👷‍♂️┇ [DEV ZASSCO](t.me/TTV_VV)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📡┇ [Source Channel](t.me/TTV_VV) 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
🤖┇ [Communication](t.me/gh_gh90bot)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
🌐┇ [Source Developer](t.me/gh_gh90)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVSanarya')..') \n🔐¦ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVSanarya')..') \n🔐¦ تـم قفـل التاك بالكتم ')  
end,nil)   
...
local UserName = (b.username_ or "Sanarya500k")
...
usertext = '\n👤¦ المستخدم » ['..result.title_..'](t.me/'..(username or 'DEVSanarya')..')'
statusk  = '\n📫¦ تم طرده من هنا'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
 usertext = '\n👤¦ المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVSanarya')..')'
 statusk  = '\n📫¦ تم طرده من هنا'
send(msg.chat_id_, msg.id_, usertext..statusk)
else
 usertext = '\n👤¦ المستخدم » '..userid..''
...
time = times * 60
local function Restricted(Kara,Sanarya)
if tonumber(Sanarya.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع كتم ( '..Rutba(Sanarya.sender_user_id_,msg.chat_id_)..' )')
return false  
end
if Can_or_NotCan(Sanarya.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع كتم ( '..Rutba(Sanarya.sender_user_id_,msg.chat_id_)..' )')
else
MuteUser(msg.chat_id_,Sanarya.sender_user_id_,msg.date_+time)
local function name(kara,Sanarya)
if Sanarya.username_ == '' then name = Sanarya.first_name_ else name = Sanarya.username_ end
send(msg.chat_id_,msg.id_,"⚠ ¦ العضو《["..name.."](tg://user?id="..Sanarya.sender_user_id_..")》\nا┄─━━◉━━─┄\n⏳¦ تم كتم لمدة "..times.." دقايق ⏰")
end
getUser(Sanarya.sender_user_id_,name)
end
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else
...
t = "\n📌¦ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local Sanarya500K_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..Sanarya500K_Msg..'}\n'    
end  
if #list == 0 then  
...
if blakrt == 'مميز 🕵🏻‍♀️' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤¦ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'DEVSanarya')..')'..'\n📬¦ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..Sanarya_Msg[math.random(#Sanarya_Msg)]..']') 
return false
end
...
send(msg.chat_id_, msg.id_,'💻¦ هاذا الامر خاص بالمطور')
...
Sanarya = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Sanarya)
...
--------------------------------------------------------------------------------------------------------------
SourceSanarya(data.message_,data)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local Sanaryabot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if Sanaryabot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..Sanaryabot.."] \n") 
